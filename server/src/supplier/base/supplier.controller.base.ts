...
import { PoHeaderFindManyArgs } from "../../poHeader/base/PoHeaderFindManyArgs";
...
export class SupplierControllerBase {
  ...
  @common.Get("/:id/supplierNo")
  @ApiNestedQuery(PoHeaderFindManyArgs)
  async findManySupplierNo(
    @common.Req() request: Request,
    @common.Param() params: SupplierWhereUniqueInput
  ): Promise<PoHeader[]> {
    const query = plainToClass(PoHeaderFindManyArgs, request.query);
    const results = await this.service.findSupplierNo(params.id, {
      ...query,
      select: {
        amount: true,
        createdAt: true,
  ...
  @common.Post("/:id/supplierNo")
  async connectSupplierNo(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: PoHeaderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      supplierNo: {
        connect: body,
  ...
  @common.Patch("/:id/supplierNo")
  async updateSupplierNo(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: PoHeaderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/supplierNo")
  async disconnectSupplierNo(
    @common.Param() params: SupplierWhereUniqueInput,
    @common.Body() body: PoHeaderWhereUniqueInput[]
  ): Promise<void> {
    const data = {
