...
describe("PoHeader", () => {
  ...
  test("GET /poHeaders/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/poHeaders"}/${nonExistingId}`)
  ...
  test("GET /poHeaders/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/poHeaders"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /poHeaders existing resource", async () => {
